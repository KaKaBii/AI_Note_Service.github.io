...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //         // 當 userName 存在時，更新頁面內容
    //         document.getElementById('toggleHeader').textContent = userName;
    //         console.log(`Fetching transcripts for: ${userName}`);
    //     } else {
    //         console.warn('User name not loaded yet. Retrying...');
    //         setTimeout(checkLocalStorage, 50); // 重試讀取
    //     }
    // };

    // checkLocalStorage(); // 開始檢查
});
